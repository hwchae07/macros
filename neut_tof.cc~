...
void gammafit()
{
  ...
  ofstream fout("./dat/neuland_gamma_offset.dat");

  h1->ProjectionY("hist",1,400);
  gDirectory->GetObject("hist",hist);
  hist->Fit("gaus","rq","",-883,-881.5);
  hist->GetXaxis()->SetRangeUser(-885,-880);
  ...
  hist->Fit("gausP2","RQ","",-883,-881.5);

  fout<<fit2->GetParameter(1);
