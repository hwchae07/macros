...
void AnaBeamPID(Int_t runNum)
{
  ...
  //32Ne Parameters for TOF(F7-F13) to Energy(Before Target)
  ...
  tree2->Branch("beamKE",&beamKE,"beamKE/D");
  ...
  for(Int_t i=0 ; i<tree->GetEntries() ; i++)
      ...
      if(!(i%1000))
	{
      ...
      Double_t gammaF7 = 1./TMath::Sqrt(1-betaF7*betaF7);
