...
void AnaRelE(Int_t runNum)
{
  ...
  tree2->Branch("neutQ",&neutQ,"neutQ/D");
  ...
  tree2->Branch("neutQU",neutQU,"neutQU[neutNum]/D");
  tree2->Branch("neutQD",neutQD,"neutQD[neutNum]/D");
	  ...
	  if(neutBeta == neutBeta1[j])
	    {
	      ...
	      neutQ = TMath::Sqrt( neutQU[j] * neutQD[j] );
